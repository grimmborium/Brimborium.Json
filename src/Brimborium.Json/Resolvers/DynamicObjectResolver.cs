...
using Brimborium.Json.Formatters;
using Brimborium.Json.Internal;
using Brimborium.Json.Internal.Emit;
using Brimborium.Json.Resolvers.Internal;
...
namespace Brimborium.Json.Resolvers.Internal {
...
#endif
    {
        ...
        const string ModuleName = "Brimborium.Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal";
...
#endif
    {
        ...
        const string ModuleName = "Brimborium.Json.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateOriginal";
    ...
    internal static class DynamicObjectTypeBuilder
    {
        ...
        static TypeInfo BuildType(DynamicAssembly assembly, Type type, Func<string, string> nameMutator, bool excludeNull)
        {
            ...
            var typeBuilder = assembly.DefineType("Brimborium.Json.Formatters." + SubtractFullNameRegex.Replace(type.FullName, "").Replace(".", "_") + "Formatter" + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed, null, new[] { formatterType });
...
#if NETSTANDARD
            public static readonly MethodInfo UnsafeMemory_MemoryCopy = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonWriter writer, byte[] src) 
...
#warning JsonSerializerUtf8
            public static readonly MethodInfo NongenericSerialize = ExpressionUtility.GetMethodInfo<Brimborium.Json.JsonWriter>(writer => JsonSerializer.NonGeneric.Serialize(default(Type), writer, default(object), default(IJsonFormatterResolver)));

            public static MethodInfo Serialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Serialize", new[] { typeof(Brimborium.Json.JsonWriter), type, typeof(IJsonFormatterResolver) });
            }

            public static MethodInfo Deserialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Deserialize", new[] { typeof(Brimborium.Json.JsonReader), typeof(IJsonFormatterResolver) });
            }
            ...
            internal static class JsonWriter
            {
                ...
                public static readonly MethodInfo WriteBeginObject = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonWriter writer) => writer.WriteBeginObject());
                public static readonly MethodInfo WriteEndObject = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonWriter writer) => writer.WriteEndObject());
                public static readonly MethodInfo WriteValueSeparator = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonWriter writer) => writer.WriteValueSeparator());
            ...
            {
                public static readonly MethodInfo ReadIsNull = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.ReadIsNull());
                public static readonly MethodInfo ReadIsBeginObjectWithVerify = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.ReadIsBeginObjectWithVerify());
                public static readonly MethodInfo ReadIsEndObjectWithSkipValueSeparator = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader, int count) => reader.ReadIsEndObjectWithSkipValueSeparator(ref count));
                public static readonly MethodInfo ReadPropertyNameSegmentUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.ReadPropertyNameSegmentRaw());
                public static readonly MethodInfo ReadNextBlock = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.ReadNextBlock());
                public static readonly MethodInfo GetBufferUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.GetBufferUnsafe());
                public static readonly MethodInfo GetCurrentOffsetUnsafe = ExpressionUtility.GetMethodInfo((Brimborium.Json.JsonReader reader) => reader.GetCurrentOffsetUnsafe());
            ...
            {
                internal static readonly MethodInfo FormatterType = ExpressionUtility.GetPropertyInfo((Brimborium.Json.JsonFormatterAttribute attr) => attr.FormatterType).GetGetMethod();
                internal static readonly MethodInfo Arguments = ExpressionUtility.GetPropertyInfo((Brimborium.Json.JsonFormatterAttribute attr) => attr.Arguments).GetGetMethod();
            }
        }
