...
namespace Brimborium.Json.Internal.Emit
{
    ...
    internal class InnerExceptionMetaMember : MetaMember
    {
        ...
        static readonly MethodInfo nongenericSerialize = ExpressionUtility.GetMethodInfo<JsonWriter>(writer => JsonSerializer.NonGeneric.Serialize(writer, default(object), default(IJsonFormatterResolver)));
